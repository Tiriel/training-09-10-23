 ...
 */
final class Version20231012141359 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, preferred_channel VARCHAR(50) DEFAULT NULL, birthday DATE DEFAULT NULL --(DC2Type:date_immutable)
        )');
